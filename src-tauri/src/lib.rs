...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .plugin(init())
        .invoke_handler(tauri::generate_handler![log_in_request,get_jwt,save_jwt,get_version,register_user,fetch_realms,fetch_changelog, fetch_news, jwt_login, delete_jwt, fetch_profile])
